import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, e as renderSlot, f as createAstro, g as renderComponent, s as spreadAttributes, u as unescapeHTML, h as renderHead } from '../astro_BhnhR_Wp.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                          */
/* empty css                          */
...
}, "C:/Users/dioog/molecular-motion/src/components/Hero.astro", void 0);
...
}, "C:/Users/dioog/molecular-motion/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const iconPaths = {
  ...
  "lightbulb": `<path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" d="M12 2a7 7 0 0 1 7 7c0 2.21-.89 4.21-2.34 5.66L15 16.34V18H9v-1.66l-1.66-1.68A7 7 0 0 1 5 9a7 7 0 0 1 7-7m1 15v2h-2v-2h2m-3 0v2H8v-2h2z"/>`,
  "rocket": `<path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" d="M2 12h2l5 5v6h6l5-5h2v-6h2v-2H2v2h2v6zm4-2h12V8l-6-6-6 6v2z"/>`,
  ...
  "facebook-logo": `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm8,191.63V152h24a8,8 0 0 0 0-16H136V112a16,16 0 0 1 16-16h16a8,8 0 0 0 0-16H152a32,32 0 0 0-32,32v24H96a8,8 0 0 0 0 16h24v63.63a88,88 0 1 1 16 0Z"/>`,
...
}, "C:/Users/dioog/molecular-motion/src/components/Icon.astro", void 0);
...
}, "C:/Users/dioog/molecular-motion/src/components/ThemeToggle.astro", void 0);
...
const $$Nav = createComponent(($$result, $$props, $$slots) => {
  ...
  const iconLinks = [
    {
      label: "Instagram",
      href: "https://instagram.com/diogo_apl",
      icon: "instagram-logo"
    },
    {
      label: "Linkedin",
      href: "https://www.linkedin.com/in/diogo-ferreira-2bastia/",
      icon: "linkedin-logo"
    },
    { label: "GitHub", href: "https://github.com/Diogo2b", icon: "github-logo" },
    {
      label: "Facebook",
      href: "https://facebook.com/Diogo2b",
      icon: "facebook-logo"
    }
  ];
...
Diogo Ferreira
  ...
  ], "class:list")}${addAttribute(href, "href")} data-astro-cid-dmqpwcec> ${label} </a> </li>`)} </ul> </noscript> <noscript> <div class="menu-footer" data-astro-cid-dmqpwcec> <div class="socials" data-astro-cid-dmqpwcec> ${iconLinks.map(({ href, icon, label }) => renderTemplate`<a${addAttribute(href, "href")} class="social" target="_blank" data-astro-cid-dmqpwcec> <span class="sr-only" data-astro-cid-dmqpwcec>${label}</span> ${renderComponent($$result, "Icon", $$Icon, { "icon": icon, "data-astro-cid-dmqpwcec": true })} </a>`)} </div> </div> </noscript> <div id="menu-content" hidden data-astro-cid-dmqpwcec> <ul class="nav-items" data-astro-cid-dmqpwcec> ${textLinks.map(({ label, href }) => renderTemplate`<li data-astro-cid-dmqpwcec> <a${addAttribute(Astro2.url.pathname === href, "aria-current")}${addAttribute([
    "link",
    {
      active: Astro2.url.pathname === href || href !== "/" && Astro2.url.pathname.startsWith(href)
    }
...
}, "C:/Users/dioog/molecular-motion/src/components/Nav.astro", void 0);
...
Designed & Developed in Bastia by <a href="mailto:dioguinho2b@gmail.com" data-astro-cid-sz7xmlte>Diogo</a> ${renderComponent($$result, "Icon", $$Icon, { "icon": "rocket-launch", "size": "1.2em", "data-astro-cid-sz7xmlte": true })} </p> <p data-astro-cid-sz7xmlte>&copy; ${currentYear} Diogo Ferreira</p> </div> <p class="socials" data-astro-cid-sz7xmlte> <a href="https://www.linkedin.com/in/diogo-ferreira-2bastia/" target="_blank" data-astro-cid-sz7xmlte>
Linkedin</a> <a href="https://github.com/Diogo2b" target="_blank" data-astro-cid-sz7xmlte> GitHub</a> <!-- <a href="https://codepen.io/me"> CodePen</a> --> </p> </footer> `;
}, "C:/Users/dioog/molecular-motion/src/components/Footer.astro", void 0);
...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="fr" data-astro-cid-37fxchfa> <head>${renderComponent($$result, "MainHead", $$MainHead, { "title": title, "description": description, "data-astro-cid-37fxchfa": true })}${renderHead()}</head> <body data-astro-cid-37fxchfa> <div class="stack backgrounds" data-astro-cid-37fxchfa> ${renderComponent($$result, "Nav", $$Nav, { "data-astro-cid-37fxchfa": true })} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-37fxchfa": true })} </div>   </body> </html>`;
}, "C:/Users/dioog/molecular-motion/src/layouts/BaseLayout.astro", void 0);
...
}, "C:/Users/dioog/molecular-motion/src/pages/404.astro", void 0);

const $$file = "C:/Users/dioog/molecular-motion/src/pages/404.astro";
const $$url = "/404";
